...
bochs.exe: iodev/libiodev.a iodev/display/libdisplay.a iodev/hdimage/libhdimage.a iodev/usb/libusb.a iodev/network/libnetwork.a iodev/sound/libsound.a \
		...
		$(SIMX86_OBJS) $(FPU_LIB)  
	link  /nologo /subsystem:console,"5.01" /incremental:no /out:$@   $(BX_OBJS) $(SIMX86_OBJS) \
...
bximage.exe: misc/bximage.o misc/hdimage.o misc/vmware3.o misc/vmware4.o misc/vpc-img.o misc/vbox.o
	link  /nologo /subsystem:console,"5.01" /incremental:no /out:$@  $(BXIMAGE_LINK_OPTS) misc/bximage.o misc/hdimage.o misc/vmware3.o misc/vmware4.o misc/vpc-img.o misc/vbox.o

niclist.exe: misc/niclist.o
	link  /nologo /subsystem:console,"5.01" /incremental:no /out:$@  misc/niclist.o

bxhub.exe: misc/bxhub.o misc/netutil.o
	link  /nologo /subsystem:console,"5.01" /incremental:no /out:$@  misc/bxhub.o misc/netutil.o ws2_32.lib
...
misc/vpc-img.o: $(srcdir)/iodev/hdimage/vpc-img.cc $(srcdir)/iodev/hdimage/vpc-img.h \
  $(srcdir)/iodev/hdimage/hdimage.h $(srcdir)/misc/bxcompat.h
	$(CXX) /c $(BX_INCDIRS) /DBXIMAGE $(CXXFLAGS_CONSOLE) $(srcdir)/iodev/hdimage/vpc-img.cc /Fo$@
